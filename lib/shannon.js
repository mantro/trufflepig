...
const FULL_SET = require('./consts').FULL_SET;
...
const shannonFull = (str) => {
    return shannon(str, FULL_SET.split(''));
}


module.exports = { shannon, shannonBase64, shannonHex, BASE64_CHARS, HEX_CHARS, FULL_SET, shannonFull};
